 ...
 * Generated at: 2023-08-11 00:17:09 UTC
...
public final class get_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("			operForm.attr(\"action\", \"/board/modify\")\r\n");
      ...
      out.write("					str += \"	<div><div class='header'>\" + list[i].replyer;\r\n");
      out.write("					str += \"		<small class='pull-right text-muted'>\" + replyService.displayTime(list[i].regDate);\r\n");
      out.write("					str += \"		</small>\";\r\n");
      out.write("					str += \"		</div>\";\r\n");
      out.write("					str += \"		<p><strong class='primary-font'>\" + list[i].reply + \"</strong></p>\";\r\n");
      out.write("					str += \"	</div>\";\r\n");
      out.write("					str += \"</li>\";\r\n");
      out.write("				}\r\n");
      ...
      out.write("			var endNum = Math.ceil(pageNum / 5.0) * 5;\r\n");
      out.write("			var startNum = endNum - 4;\r\n");
      out.write("			\r\n");
      ...
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			var str = \"<ul class='pagination justify-content-center'>\";\r\n");
      out.write("			\r\n");
      out.write("			if(prev){\r\n");
      ...
      out.write("			console.log(replyPageFooter);\r\n");
      out.write("			console.log(\"prev \" + replyPageFooter.html());\r\n");
      out.write("			replyPageFooter.html(str);\r\n");
      out.write("			console.log(\"next \" + replyPageFooter.html());\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("		// 페이지 번호 클릭 이벤트\r\n");
      ...
      out.write("		var modalInputRegDate = modal.find(\"input[name='regDate']\");\r\n");
      out.write("		\r\n");
      ...
      out.write("			modalInputRegDate.closest(\"div\").hide();\r\n");
      ...
      out.write("			\r\n");
      out.write("			console.log($(\".modal-body\").find(\"input[name='reply']\").length);\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		// 새 댓글 입력\r\n");
      ...
      out.write("			};\r\n");
      out.write("			\r\n");
      out.write("			// 댓글 내용/작성자 validation check\r\n");
      out.write("			var replyArea = $(\"#myModal\").find(\"input[name='reply']\");\r\n");
      out.write("			var replyerArea = $(\"#myModal\").find(\"input[name='replyer']\");\r\n");
      out.write("			\r\n");
      out.write("			if(replyArea.val() == \"\" || replyArea.val().length < 1) {\r\n");
      out.write("				alert(\"내용을 입력해주세요.\");\r\n");
      out.write("				replyArea.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      out.write("			if(replyerArea.val() == \"\" || replyerArea.val().length < 1) {\r\n");
      out.write("				alert(\"작성자를 입력해주세요.\");\r\n");
      out.write("				replyerArea.focus();\r\n");
      out.write("				return false;\r\n");
      out.write("			}\r\n");
      out.write("			\r\n");
      ...
      out.write("				\r\n");
      out.write("				// 댓글 리스트 새로고침\r\n");
      out.write("				showList(1);\r\n");
      out.write("			});\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		// 모달 내 close 버튼 클릭 이벤트\r\n");
      out.write("		$(\"#modalCloseBtn\").on(\"click\", function(){\r\n");
      out.write("			// 모달 창 닫기\r\n");
      out.write("			$(\".modal\").modal(\"hide\");\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		// 댓글 항목 클릭 이벤트\r\n");
      ...
      out.write("				modalInputRegDate.val(replyService.displayTime(reply.regDate)).attr(\"readonly\", \"readonly\");\r\n");
      out.write("				modal.data(\"rno\", reply.rno);\r\n");
      out.write("				\r\n");
      out.write("				// closest -> 왼쪽 태그를 기준으로 가장 가까이에 있는 부모 태그 선택\r\n");
      out.write("				modalInputRegDate.closest(\"div\").show();\r\n");
      out.write("				modal.find(\"button[id != 'modalCloseBtn']\").hide();\r\n");
      ...
      out.write("					<input class=\"form-control\" name=\"content\" value=\"");
      ...
      out.write("	</div>\r\n");
      out.write("	\r\n");
      out.write("	<div class=\"row mt-xl-5\">\r\n");
      ...
      out.write("			        <div class=\"form-group\">\r\n");
      out.write("			          <label>RegDate</label> \r\n");
      out.write("			          <input class=\"form-control\" name='regDate' value='2018-01-01 13:13'>\r\n");
      out.write("			        </div>\r\n");
      out.write("		      	</div>\r\n");
      ...
      out.write("			        <button id='modalCloseBtn' type=\"button\" class=\"btn btn-primary\">Close</button>\r\n");
      out.write("		      	</div>          \r\n");
      out.write("	      	</div>\r\n");
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(262,13) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatDate_005f0.setPattern("yyyy/MM/dd");
      // /WEB-INF/views/board/get.jsp(262,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/board/get.jsp(268,13) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatDate_005f1.setPattern("yyyy/MM/dd");
      // /WEB-INF/views/board/get.jsp(268,13) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
